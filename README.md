...
10. Меню и неигровые компоненты (максимальный балл - 56):
    * В самой игре имеется HUD (heads-up display) в котором отображено общее количество очков и количество оставшихся жизней игрока, +11
    * Имеется экран загрузки компонентов игры, на котором есть полоса прогресса и процент загрузки игры, +15
    * Имеется главное меню игры, появляющееся при первой загрузке игры, в меню имеются 3 пункта: "start game" - запускается новая игра, "load game" - если имеется сохраненная игра, она загружается, "options" - переход к настройкам игры, +15
